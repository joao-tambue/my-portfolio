            ...
            <div className={`${asap.variable} ${inconsolata.variable} ${mavenPro.variable}`}>
                ...
                <div className="flex flex-col items-center gap-4 max-w-3xl mx-auto">
                    <Accordion type="single" collapsible className="w-full">
                        <AccordionItem value="item-2" className="bg-[#20232A] px-4 rounded-lg hover:border hover:border-[#e3646e] hover:rounded-lg hover:transition-colors hover:duration-300 cursor-pointer">
                    ...
                    <Accordion type="single" collapsible className="w-full">
                        <AccordionItem value="item-2" className="bg-[#20232A] px-4 rounded-lg hover:border hover:border-[#e3646e] hover:rounded-lg transition-colors duration-300">
                            <AccordionTrigger className="text-white hover:no-underline cursor-pointer">
                                <div className="flex flex-col gap-2">
                                    <h3 className="text-3xl font-semibold" style={typography.titleSm}>Osapi Care <span className="text-gray-400 text-xl " style={typography.textSm}>- Mar 2025 - jun 2025</span> </h3>
                                    <div className="flex items-center gap-2">
                    ...
                    <Accordion type="single" collapsible className="w-full">
                        <AccordionItem value="item-2" className="bg-[#20232A] px-4 rounded-lg hover:border hover:border-[#e3646e] hover:rounded-lg transition-colors duration-300">
                            <AccordionTrigger className="text-white hover:no-underline cursor-pointer">
                                <div className="flex flex-col gap-2">
                                    <h3 className="text-3xl font-semibold" style={typography.titleSm}> Sky Dev <span className="text-gray-400 text-xl " style={typography.textSm}>- jun 2025 - At the moment</span> </h3>
                                    <div className="flex items-center gap-2">
                                        <Badge variant="secondary">Front-end Developer</Badge>
                                    </div>
